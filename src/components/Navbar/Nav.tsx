...
const Nav: FC = () => {
  ...
  return (
    <nav className="nav relative py-6 border-b border-solid border-border-10">
      <div className="nav__wrapper container flex items-center justify-between gap-10 lg:justify-start">
        <Link className="nav__brand font-integral text-3xl font-bold" to={'/'}>
          SHOP.CO
        </Link>
